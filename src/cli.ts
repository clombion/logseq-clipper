...
function printUsage(): void {
	const usage = `
Usage: logseq-clipper <url> [options]
...
Options:
  ...
  -o, --output <path>          Output .md file path (default: stdout)
      ...
      --vault <name>           Logseq graph name
      --open                   Send to Logseq instead of writing file
      --uri                    Use URI scheme instead of Logseq CLI
      --silent                 Suppress Logseq focus (URI mode)
